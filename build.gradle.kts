...
//    implementation(kotlin("stdlib"))
    ...
    kapt("io.javalin.community.openapi:openapi-annotation-processor:7.2.2")
    implementation("io.javalin.community.openapi:javalin-openapi-plugin:7.2.2") // for /openapi route with JSON scheme
