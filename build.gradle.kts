...
//    implementation(kotlin("stdlib"))
    ...
    kapt("io.javalin.community.openapi:openapi-annotation-processor:7.0.1")
    implementation("io.javalin.community.openapi:javalin-openapi-plugin:7.0.1") // for /openapi route with JSON scheme
    implementation("io.javalin.community.openapi:javalin-swagger-plugin:7.0.1") // for Swagger UI
    implementation("io.javalin.community.openapi:javalin-redoc-plugin:7.0.1") // for ReDoc UI
