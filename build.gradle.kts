...
//    implementation(kotlin("stdlib"))
    ...
    kapt("io.javalin.community.openapi:openapi-annotation-processor:6.0.0-3")
    implementation("io.javalin.community.openapi:javalin-openapi-plugin:6.0.0-3") // for /openapi route with JSON scheme
    implementation("io.javalin.community.openapi:javalin-swagger-plugin:6.0.0-3") // for Swagger UI
    implementation("io.javalin.community.openapi:javalin-redoc-plugin:6.0.0-3") // for ReDoc UI
