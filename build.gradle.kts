...
//    implementation(kotlin("stdlib"))
    ...
    kapt("io.javalin.community.openapi:openapi-annotation-processor:7.2.3")
    implementation("io.javalin.community.openapi:javalin-openapi-plugin:7.2.3") // for /openapi route with JSON scheme
    implementation("io.javalin.community.openapi:javalin-swagger-plugin:7.2.3") // for Swagger UI
    implementation("io.javalin.community.openapi:javalin-redoc-plugin:7.2.3") // for ReDoc UI
    implementation("io.javalin:javalin-rendering:7.2.3")
