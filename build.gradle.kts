...
//    implementation(kotlin("stdlib"))
    ...
    kapt("io.javalin.community.openapi:openapi-annotation-processor:6.1.4")
    implementation("io.javalin.community.openapi:javalin-openapi-plugin:6.1.4") // for /openapi route with JSON scheme
    implementation("io.javalin.community.openapi:javalin-swagger-plugin:6.1.4") // for Swagger UI
    implementation("io.javalin.community.openapi:javalin-redoc-plugin:6.1.4") // for ReDoc UI
...
//    testImplementation(kotlin("test"))
    ...
    testImplementation("io.javalin:javalin-testtools:6.1.4")
}
