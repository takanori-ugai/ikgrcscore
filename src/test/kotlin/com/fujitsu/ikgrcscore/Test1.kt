...
class Test1 {
    ...
    fun testHelloPageDefaultValues() = JavalinTest.test(App().app) { _, client ->
...
//        assertEquals(str, client.get("/Senario/id").body?.string())
    ...
    fun testSenarioId() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(
...
//        assertEquals(str, client.get("/Senario/id").body?.string())
    ...
    fun testQ1() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
    ...
    fun testQ2() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
    ...
    fun testQ2empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ3() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
    ...
    fun testQ3empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ4() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
    ...
    fun testQ4empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ5() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
    ...
    fun testQ5empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ6() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
    ...
    fun testQ6empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ7() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
        // Assert that the response from the /Q7 endpoint is equal to the expected JSON
        assertEquals(str, client.post("/Q7", Q7answer("Takanori Ugai", "Senario1", listOf(Q7data("Table", "Cup", "ON")))).body?.string())
    }
    ...
    fun testQ7empty() = JavalinTest.test(App().app) { _, client ->
    ...
    fun testQ8() = JavalinTest.test(App().app) { _, client ->
        // Convert an array of strings to JSON
        val str = JavalinJackson().toJsonString(Success(data = SuccessData(0.3, 3)))
        // Assert that the response from the /Q8 endpoint is equal to the expected JSON
        assertEquals(str, client.post("/Q8", Q8answer("Takanori Ugai", "Senario1", listOf(Q8data("Table", listOf(Q8element(listOf(1.1, 2.5, 3.2), listOf("ON", "CLEAN"))))))).body?.string())
    }
    ...
    fun testQ8empty() = JavalinTest.test(App().app) { _, client ->
